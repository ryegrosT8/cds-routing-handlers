...
var CDSHandler = /** @class */ (function () {
    ...
    CDSHandler.registerMiddlewareClasses = function (metadataBuilder, srv, middlewareClasses, userChecker) {
        ...
        var globalSortedMiddlewares = middlewares
            .filter(function (m) { return m.global; })
            .sort(function (a, b) {
        ...
        var usageMiddlewares = middlewares.filter(function (m) { return !m.global; });
                ...
                try {
                    switch (action.handler) {
                        ...
                        case HandlerType_1.HandlerType.On:
                            if (action.operation === ODataOperation_1.ODataOperation.Function ||
    ...
    CDSHandler.registerBeforeHandler = function (srv, action) {
        ...
        if (action.entity !== undefined) {
            srv.before(action.operation, action.entity, function (req, next) { return __awaiter(_this, void 0, void 0, function () {
                var context;
    ...
    CDSHandler.registerOnHandler = function (srv, action) {
        var _this = this;
        if (action.entity !== undefined) {
            srv.on(action.operation, action.entity, function (req, next) { return __awaiter(_this, void 0, void 0, function () {
                var context;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
    ...
    CDSHandler.registerAfterHandler = function (srv, action) {
        var _this = this;
        if (action.entity !== undefined) {
            srv.after(action.operation, action.entity, function (entities, req) { return __awaiter(_this, void 0, void 0, function () {
                var context;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
    ...
    CDSHandler.registerFunctionImportHandler = function (srv, action) {
        var _this = this;
        if (action.entity === undefined) {
            srv.on(action.functionImportName, function (req, next) { return __awaiter(_this, void 0, void 0, function () {
                var context;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
            ...
            srv.on(action.functionImportName, action.entity, function (req, next) { return __awaiter(_this, void 0, void 0, function () {
                var context;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
    ...
    CDSHandler.registerMiddleware = function (srv, middleware) {
        ...
        switch (middleware.runtime) {
            case MiddlewareRuntime_1.MiddlewareRuntime.Normal:
                srv.before("*", function (req, next) { return __awaiter(_this, void 0, void 0, function () {
                    var context;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
            ...
            case MiddlewareRuntime_1.MiddlewareRuntime.BeforeDefaults:
                if ((_b = (_a = srv === null || srv === void 0 ? void 0 : srv._handlers) === null || _a === void 0 ? void 0 : _a.initial) === null || _b === void 0 ? void 0 : _b._handlers) {
                    srv._handlers.initial._handlers.unshift({
                        event: "*",
                        entity: undefined,
                        handler: function (req, next) { return __awaiter(_this, void 0, void 0, function () {
                            var context;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
            ...
            case MiddlewareRuntime_1.MiddlewareRuntime.AfterDefaults:
                if (srv === null || srv === void 0 ? void 0 : srv._initial) {
                    srv._initial("*", function (req, next) { return __awaiter(_this, void 0, void 0, function () {
                        var context;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
